...
<<<<<<< HEAD
      <div v-for="item in cart.items" :key="item.lineId" class="cart-item">
        ...
        <div class="cart-item-info">
          ...
          <div class="cart-item-variant" v-if="item.size || item.sugarIce || item.toppings?.length">
...
.btn-brown {
  background-color: var(--fashion-primary, #2b1c12);
  border-color: var(--fashion-primary, #2b1c12);
  color: white;
  text-align: center;
}
.btn-brown:hover {
  background-color: var(--fashion-light, #4a4a4a);
  color: white;
}
