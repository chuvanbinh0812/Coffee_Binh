...
.msg-user .msg-bubble { background: #2b1c12; color: white; border-bottom-right-radius: 4px; }
.msg-admin .msg-bubble { background: #efe1c3; color: #333; border-bottom-left-radius: 4px; }
...
.chat-input input:focus { border-color: #2b1c12; }
.chat-input button {
  background: #2b1c12;
  color: white;
  border: none;
...
.chat-input button:hover { background: #4a4a4a; }
